...
class EloquentSitemanagerProductOptionMapper extends InventoryItem
{
    use EntityMapperTrait;
    use ModelMapperTrait;

    protected static function reconstituteEntityCore(EloquentSitemanagerProductOption $model): InventoryItem
    {
    ...
    {
        $model = new EloquentSitemanagerProductOption();
    ...
    protected static function updateModelCore(InventoryItem $entity, EloquentSitemanagerProductOption $model): void
    {
        // TODO: Map properties
        $model->id = $entity->id;
        $model->productnumber_internal = $entity->productCode;
    ...
    protected static function deleteModelCore(EloquentSitemanagerProductOption $model): void
    {
        // purgeModel hasOne's
    ...
    protected static function pruneModelCore(InventoryItem $entity, EloquentSitemanagerProductOption $model): void
    {
        // pruneModel hasOne's
